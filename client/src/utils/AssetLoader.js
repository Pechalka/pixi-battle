...
export class AssetLoader {
    static async loadAssets() {
        ...
        const textures = {
            ...
            enemyTankBasicUp: [this.extractTexture(spritesheet, 16 * 8, 0, 16, 16), this.extractTexture(spritesheet, 16 * 9, 0, 16, 16)],
            enemyTankBasicLeft: [this.extractTexture(spritesheet, 16 * 10, 0, 16, 16), this.extractTexture(spritesheet, 16 * 11, 0, 16, 16)],
            enemyTankBasicDown: [this.extractTexture(spritesheet, 16 * 12, 0, 16, 16), this.extractTexture(spritesheet, 16 * 13, 0, 16, 16)],
            enemyTankBasicRight: [this.extractTexture(spritesheet, 16 * 14, 0, 16, 16), this.extractTexture(spritesheet, 16 * 15, 0, 16, 16)],
            ...
            // АНИМАЦИИ И ЭФФЕКТЫ
            explosionSmall: this.extractTexture(spritesheet, 16 * 16, 16 * 8, 16, 16), // Маленький взрыв
            explosionMiddle: this.extractTexture(spritesheet, 16 * 17, 16 * 8, 16, 16), // Средний взрыв
            explosionBig: this.extractTexture(spritesheet, 16 * 18, 16 * 8, 16, 16),   // Большой взрыв
